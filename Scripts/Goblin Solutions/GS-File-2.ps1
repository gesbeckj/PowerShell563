...
New-NetIPAddress -InterfaceAlias Ethernet -IPAddress 10.100.63.22 -AddressFamily IPv4 -PrefixLength 24
...
Add-Computer -DomainName "ad.goblinsolutions.tk" -Credential (Get-Credential) -NewName "GS-File-2"
