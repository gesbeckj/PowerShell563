<#
.SYNOPSIS
This creates a GPT/UEFI VHDX from a WIM file. 
.DESCRIPTION
This creates a GPT/UEFI VHDX from a WIM file. 
.EXAMPLE
Deploy-WimToVHDX -VHDXFile "C:\Test.VHDX" -SourceFile "C:\Server2016.wim" -Index 1 -VHDSize 30GB
.NOTES
...
param (
    ...
    #Index of WIM File for Image to Use
    [Parameter(Mandatory)]
    [ValidateNotNullOrEmpty()]
    [int]$Index,
