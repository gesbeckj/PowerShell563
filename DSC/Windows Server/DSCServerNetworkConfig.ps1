...
ServerNetworkConfig -ComputerName $ComputerName -InterfaceAlias $InterfaceAlias -IPv4Address $IPv4Address -PrefixLength $PrefixLength -Gateway $Gateway -DNSServers $DNSServers -path $Path